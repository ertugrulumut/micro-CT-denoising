...
% following name should work for both UPPERCASE and LOWERCASE names
 \author{Ertu\u{g}rul Umut Y\i{}ld\i{}r\i{}m}
% Thesis Title English and Turkish
\title{Quality Enhancement of Computed Tomography Images of Porous Media Using Convolutional Neural Networks}
\turkishtitle{
Evrişimli Sinir Ağları Kullanarak Gözenekli Ortamın Bilgisayarlı Tomografi Görüntülerinin Kalitesinin İyileştirilmesi}
...
% Head of Department
\headofdept[assocprof]{Hamdullah Yücel}
%
% Supervisor : English and Turkish
\supervisor[prof]{Ömür Uğur}
\cosupervisor[assistprof]{Guenther Glatz} % suppress/comment if you don't have cosupervisor
...
\departmentofcosupervisor{Petroleum Engineering Department, KFUPM}
%
% Committee Members
...
\keywords{deep learning, convolutional neural networks, computed tomography images, image denoising, image quality improvement}
\anahtarklm{derin öğrenme, evrişimli sinir ağları, bilgisayarlı tomografi görüntüleri, gürültü giderme, görüntü kalitesi iyileştirme}
